...
the contributor workflow; product context lives in [README.md](README.md) and
[docs/VISION.md](docs/VISION.md), while agent working rules live in
[AGENTS.md](AGENTS.md).
...
- New here? Start with [docs/ROADMAP.md](docs/ROADMAP.md) for current
  sequencing, then [docs/BACKLOG.md](docs/BACKLOG.md) and [PLAN.md](PLAN.md).
